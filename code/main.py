...
class Ui_MainWindow(object):
    ...
    def slot_save_selected_subontology(self):
        ...
        mess_box = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Icon.Information ,'Сохранено', 'Онтология, указанного документа, успешна сохранена!', QtWidgets.QMessageBox.StandardButton.Ok)
        mess_box.exec_()
