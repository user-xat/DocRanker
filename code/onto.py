...
class Onto:
    ...
    def write_to_file(self, filename):
        ...
        '''
        with open(filename+'.ont', "w", encoding='utf-8') as f:
    ...
    def add_node(self, name, position_x:float = 0, position_y:float = 0, attributes = None):
        '''
        Add new node to ontology.
        @param name - string name of node.
        @param position_x - the x coordinate of the node.
        @param position_y - the y coordinate of the node.
